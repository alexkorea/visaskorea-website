...
<h1>F-2 거주비자 점수제 완벽 가이드</h1>

F-2 거주비자 점수제는 한국에서 외국인이 안정적으로 거주할 수 있도록 지원하는 제도입니다. 이 비자를 취득하기 위해서는 다양한 점수를 합산하여 일정 기준에 도달해야 하며, 이는 개인의 자격 요건을 기반으로 합니다. 

<nav style="background:#f0f7ff;padding:20px;border-radius:8px;margin-bottom:30px"><h3 style="color:#1e40af;margin-top:0">목차</h3><ul style="list-style:none;padding:0"><li><a href="#requirements" style="color:#2563eb;text-decoration:none">F-2 비자 자격 요건</a></li><li><a href="#scoring" style="color:#2563eb;text-decoration:none">점수 산정 기준</a></li><li><a href="#application" style="color:#2563eb;text-decoration:none">신청 절차</a></li><li><a href="#common_mistakes" style="color:#2563eb;text-decoration:none">주요 실수 및 주의사항</a></li><li><a href="#faq" style="color:#2563eb;text-decoration:none">자주 묻는 질문</a></li></ul></nav>
...
<li>F-2 비자는 외국인이 한국에 거주할 수 있도록 하는 비자입니다.</li>
<li>점수는 연령, 학력, 경력, 한국어 능력 등 다양한 요소에 따라 산정됩니다.</li>
...
<ul>
<li>연령: 18세 이상 55세 이하의 개인이 점수를 받습니다.</li>
<li>학력: 고졸 이상의 학력이 요구되며, 학위에 따라 점수가 달라집니다.</li>
<li>경력: 직장 경력에 따라 추가 점수를 받을 수 있습니다.</li>
<li>한국어 능력: TOPIK 점수에 따라 점수가 부여됩니다.</li>
</ul>
