...
export const criminalCategoryJa: CategoryData = {
  ...
  hero: {
    ...
    description: '過去の出入国法違反や犯罪記録が韓国への入国・滞在の障害になっていませんか？VISION行政書士事務所が出入国管理法に基づく専門的な対応で解決策をお探しします。',
  },
  ...
  cta: {
    title: '秘密厳守 無料相談',
    description: '入国禁止、強制退去、犯罪記録などでお悩みですか？すべての相談は厳格に秘密が守られます。出入国管理法専門の行政書士が解決策をお探しします。',
    primaryButton: {
      text: '秘密相談を申請',
  ...
  seo: {
    title: '犯罪審査 | 入国禁止解除・強制退去防御・犯罪経歴審査 | VISION行政書士事務所',
    description: '入国禁止解除、強制退去異議申立て、犯罪経歴審査対応、不法滞在救済の専門サービス。韓国出入国管理法に基づく専門行政書士相談。',
